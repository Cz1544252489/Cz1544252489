- 👋 Hi, I’m @Cz1544252489 currently pursuing my Ph.D. in **Operations Research and Control Theory** (under mathematics).
- 👀 I’m interested in Math. and server tech.
...
- 🩹 I’m learning bilevel optimization as well as geometric optimization, and trying to apply it to machine learning.
- 💞️ I’m coding on MATLAB, Python, Shell(Linux) and C++.
- 📝 Work and study with [Trilium Notes](https://github.com/TriliumNext/Trilium), a note-taking app with **36k+** GitHub stars.
- 🎹 Music streaming with [Navidrome](https://github.com/navidrome/navidrome), a music server with **21k+** GitHub stars.
- 📖 Reading with [Kavita](https://github.com/Kareadita/Kavita), a digital library server with **10k+** GitHub stars.
...
- 🔐 Password management with [Vaultwarden](https://github.com/dani-garcia/vaultwarden), a Bitwarden-compatible server with **60k+** GitHub stars, after nearly a year of trying self-hosting and a paid subscription.
